<x-guest-layout>
    <div class="w-full sm:max-w-md px-6 py-8 bg-white/90 backdrop-blur-sm shadow-xl overflow-hidden sm:rounded-lg border border-gray-100">
        <div class="flex justify-center mb-6">
            <svg class="h-12 w-auto text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h1 class="text-center text-2xl font-bold mb-2 text-gray-800">Wyszukiwarka Broni</h1>
        <h2 class="text-center text-lg font-medium mb-6 text-blue-600">Utwórz nowe konto</h2>
        ...
        <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ms-2">
                                {!! __('Akceptuję :terms_of_service oraz :privacy_policy', [
                                        'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="text-sm font-medium text-blue-600 hover:text-blue-700">'.__('Regulamin').'</a>',
                                        'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="text-sm font-medium text-blue-600 hover:text-blue-700">'.__('Politykę Prywatności').'</a>',
                                ]) !!}
                            </div>
                        </div>
                    </x-label>
            ...
            <div class="flex items-center justify-center mt-6 pt-4 border-t border-gray-200">
                ...
                <a class="ml-1 text-sm font-medium text-blue-600 hover:text-blue-700" href="{{ route('login') }}">
                    Zaloguj się
                </a>
            </div>
        </form>
